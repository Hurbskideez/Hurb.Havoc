...
global function MpTitanweaponBurstMine_Init
global function OnWeaponPrimaryAttack_titanweapon_burst_mine
global function OnProjectileCollision_titanweapon_burst_mine
global function OnWeaponAttemptOffhandSwitch_titanweapon_burst_mine

#if SERVER
global function OnWeaponNpcPrimaryAttack_titanweapon_burst_mine
#endif // #if SERVER
...
function MpTitanweaponBurstMine_Init()
{
	PrecacheWeapon("mp_titanweapon_burst_mine")
	#if SERVER
		AddDamageCallbackSourceID( eDamageSourceId.mp_titanweapon_burst_mine, BurstMineOnDamage )
	#endif
}

var function OnWeaponPrimaryAttack_titanweapon_burst_mine( entity weapon, WeaponPrimaryAttackParams attackParams )
{
...
#if SERVER
var function OnWeaponNpcPrimaryAttack_titanweapon_burst_mine( entity weapon, WeaponPrimaryAttackParams attackParams )
{
	weapon.EmitWeaponNpcSound( LOUD_WEAPON_AI_SOUND_RADIUS_MP, 0.2 )
...
bool function OnWeaponAttemptOffhandSwitch_titanweapon_burst_mine( entity weapon )
{
...
void function OnProjectileCollision_titanweapon_burst_mine( entity projectile, vector pos, vector normal, entity hitEnt, int hitbox, bool isCritical )
{
	...
	projectile.SetAngles( startAngle )
		...
		EmitSoundOnEntity( projectile, "weapon_softball_grenade_attached_3P" )
			...
			thread UpdateBurstMineField(weaponOwner, projectile, origin, 5, 0.85)
...
#if SERVER
void
function UpdateBurstMineField(entity owner, entity projectile, vector origin, int burstCount, float delay)
{
	...
	float endTime = Time() + duration
  	...
  	for(int i = 0; i < burstCount; i++) {
		...
		BurstMineFieldDamage( owner, projectile, origin )
...
function BurstMineFieldDamage( entity owner, entity pylon, vector origin )
{
    RadiusDamage(
        origin,									// center
        owner,									// attacker
        ...
        eDamageSourceId.mp_titanweapon_burst_mine )			// scriptDamageSourceIdentifier
}
#endif // SERVER
...
#if SERVER
void function BurstMineOnDamage( entity ent, var damageInfo )
{
